...
* `filter_data()` has a new argument `filter_establishmentMeans` that allows custom filtering taxa based on establishmentMeans (e.g. native, introduced), instead of build in filtering on "introduced" taxa (#24).
