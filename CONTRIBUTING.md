# Contributing to elodea

This outlines how to propose a change to elodea. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("onestop-project/elodea", fork = TRUE)`.
...
Please note that the elodea project is released with a [Contributor Code
of
Conduct](https://onestop-project.github.io/elodea/CODE_OF_CONDUCT.md).
